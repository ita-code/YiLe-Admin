<template>
  <div id="confirm">
    ...
    <transition name="fade">
      <div v-if="isVisible" @click="handleClose" class="w-screen h-screen bg-zinc-900/80 z-40 fixed top-0 left-0"></div>
    </transition>
    <!-- 内容 -->
    <transition name="up">
      <div
      ...
      >
        ...
        <div class="flex justify-end">
          <hm-button type="info" class="mr-2" @click="handleCancel">{{ cancelText }}</hm-button>
          <hm-button type="primary" @click="handleConfirm">{{ confirmText }}</hm-button>
        </div>
      </div>
    </transition>
  </div>
